To run the loadbalancer, first open up the httpservers that will be used by the loadbalancer. Next run the loadbalancer with the port for the loadbalancer followed by the ports of the httpservers.
